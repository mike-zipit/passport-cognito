 ...
 * @access protected
 */
CognitoStrategy.prototype._getClientDetails = function(username, clientName, cb) {
  if(this._clientDetailsLookup){
    ...
    return this.fail({ message: 'Requires either options.clientDetailsLookup or [options.userPoolId + options.clientId] to be set' }, 400);
  }
};
